// TAKEN FROM: https://github.com/dochong/drachtio-freeswitch-modules/blob/master/examples/ws_server.js
...
console.log(
  `listening on port ${port}, writing incoming raw audio to file ${recordingPath}`,
);
